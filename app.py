...
def admin_cms():
    ...
    return render_template(
        "admin_cms.html", content=cms_data, leads=leads_data)
...
def admin_cms_update():
    ...
    cms_data["home"]["hero_title"] = request.form.get(
        "home_hero_title", cms_data["home"]["hero_title"])
    cms_data["home"]["hero_subtitle"] = request.form.get(
        "home_hero_subtitle", cms_data["home"]["hero_subtitle"])
    cms_data["home"]["value_prop_title"] = request.form.get(
        "home_value_prop_title", cms_data["home"]["value_prop_title"])
    cms_data["home"]["value_prop_text"] = request.form.get(
        "home_value_prop_text", cms_data["home"]["value_prop_text"])

    cms_data["services"]["ai_agentic"]["title"] = request.form.get(
        "service_ai_title", cms_data["services"]["ai_agentic"]["title"])
    cms_data["services"]["ai_agentic"]["subtitle"] = request.form.get(
        "service_ai_subtitle", cms_data["services"]["ai_agentic"]["subtitle"])
    cms_data["services"]["ai_agentic"]["content"] = request.form.get(
        "service_ai_content", cms_data["services"]["ai_agentic"]["content"])
...
def submit_lead():
    ...
    if save_lead(lead_entry):
        flash(
            "Strategy request submitted successfully! An advisor will reach out shortly.",
            "success")
    else:
